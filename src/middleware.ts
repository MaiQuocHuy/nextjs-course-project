...
const roleRouteMap = [
  ...
  { path: '/instructor/courses', roles: ['INSTRUCTOR'] },
  { 
  ...
  { path: '/instructor/courses/edit-course', roles: ['INSTRUCTOR'] },
  { 
    path: /^\/instructor\/courses\/edit-course\/[^\/]+$/,
    roles: ['INSTRUCTOR'],
    isDynamic: true,
    description: 'Edit specific course'
  },
  { path: '/instructor/courses/create-course', roles: ['INSTRUCTOR'] },
  { path: '/instructor/earnings', roles: ['INSTRUCTOR'] },
  { path: '/instructor/payouts', roles: ['INSTRUCTOR'] },
  { path: '/instructor/quiz', roles: ['INSTRUCTOR'] },
  { path: '/instructor/students', roles: ['INSTRUCTOR'] },
